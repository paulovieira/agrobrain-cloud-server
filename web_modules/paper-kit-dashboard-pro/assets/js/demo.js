...
demo = {
    ...
    initStatsDashboard: function(){
        ...
        var data = {
          labels: ['18','21','23', '2', '4', '8', '14', '17', '20', '23', '4', '8'],
          series: [
            [12, 11, 8, 7, 4, 2, 3, 5, 8, 10, 11, 12],
            [3, 3, 4, 4, 5, 6, 7, 8, 9, 8, 5, 3]
		  ]
        };
    ...
    initChartsPage: function(){
        ...
        var data = {
          labels: ['6pm','9pm','11pm', '2am', '4am', '8am', '2pm', '5pm', '8pm', '11pm', '4am', '8am'],
          series: [
            [12, 11, 8, 7, 4, 2, 3, 5, 8, 10, 11, 12],
            [7, 7, 5, 4, 3, 3, 3, 3, 4, 5, 10, 11]
		  ]
        };
    ...
    showSwal: function(type){
        if(type == 'basic'){
        	...
        	swal({  title: "Tem a certeza?",
                    ...
                    if (isConfirm){
                        swal("Desligado!", "O seu sistema de rega irá fechar.", "success");
                    }else{
                        swal("Cancelado", "Operação de desligar a rega cancelada", "");
                    }
                });

    	}else if(type == 'custom-html'){
        	swal({  title: 'Adicionar acção!',
                    html:
            ...
            swal({
                  title: '',
                  html: '<iframe src="../../spinon/pages/wizard.html" frameborder="0" scrolling="no" height="300px" width="900px"></iframe>',
                  showCancelButton: true,
                  closeOnConfirm: false,
